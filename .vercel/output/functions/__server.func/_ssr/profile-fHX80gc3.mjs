...
import { P as cn, T as progressFromXp, o as Input, p as useGymStore, r as UserButton, s as Button } from "./router-BFutvdcX.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/profile-fHX80gc3.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					children: "段位按估計 1RM 同體重比例對照典型健身人口。黑鐵至鑽石各分 3、2、1（1 最高），之後係大師同宗師。白金大約係全球前 40%。登入後訓練資料會存到雲端。"
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
				variant: "destructive",
