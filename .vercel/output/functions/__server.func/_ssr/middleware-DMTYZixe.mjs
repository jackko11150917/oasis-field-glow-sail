...
//#region node_modules/.nitro/vite/services/ssr/assets/middleware-DMTYZixe.js
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0002_gym.sql": _0002_gym_default
		});
...
var authMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	...
	const { requireUserId } = await import("./verify.server-BH0B60CI.mjs");
