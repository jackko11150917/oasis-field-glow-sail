...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ClPjys9f.mjs");
...
var manifest = {
	"1ab9367f35fe0ab1ba913e3d349bfbefeec7d6701101a6affa3f1e42cde95052": {
		functionName: "replaceGymWorkouts_createServerFn_handler",
		importer: () => import("./gym-api-BRcITnS_.mjs")
	},
	"6ed4ca5135cece7019af9c92b97351e160410a1f832b01b7c8cd2b89b9e4c3e4": {
		functionName: "clearGymCloud_createServerFn_handler",
		importer: () => import("./gym-api-BRcITnS_.mjs")
	},
	"7f412f288bf0a2e0417681ebaaafe6beebb1340c3e88aec635b5b27fa02824ef": {
		functionName: "loadGymState_createServerFn_handler",
		importer: () => import("./gym-api-BRcITnS_.mjs")
	},
	"b469b218e3c353098fe0dae6f0a73591b14831637c6dc6cf3d5240e6f74e5fa1": {
		functionName: "saveGymSnapshot_createServerFn_handler",
		importer: () => import("./gym-api-BRcITnS_.mjs")
	},
	"da984a8634cb520cd0b24217da22206d870048ac148887dd8bda51c4f10d6f94": {
		functionName: "saveGymWorkout_createServerFn_handler",
		importer: () => import("./gym-api-BRcITnS_.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BFutvdcX.mjs").then((n) => n.t),
