...
import { A as getExercise, C as workoutVolume, D as EXERCISES, I as rankForLevel, O as MUSCLE_LABELS, P as cn, a as RankEmblem, h as completedSetCount, j as SHOWCASE_RANK, k as TEMPLATES, o as Input, p as useGymStore, s as Button, u as EQUIPMENT_LABELS, y as loadKindHint } from "./router-BFutvdcX.mjs";
import { t as ExerciseIcon } from "./exercise-icon-SylKqOIH.mjs";
import { t as Drawer } from "../_libs/vaul.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/train-Dbvq0wNu.js
...
function TrainPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrainInner, {});
}
function TrainInner() {
				...
				children: [TEMPLATES.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: t.exerciseIds.slice(0, 3).map((id) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExerciseIcon, {
								id,
								size: 32,
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					className: "max-w-[14rem] truncate font-display text-3xl tracking-wide",
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExerciseIcon, {
										id: ex.id,
										size: 36
...
function Stepper({ value, onChange, step, min }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex h-10 min-w-0 items-center rounded-sm border border-border bg-elevated",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				type: "button",
